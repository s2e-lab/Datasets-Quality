...
TARGET_DATASET = [
    {
    "Source_Path": "../../datasets/CoderEval/CoderEval4Java.json",
    "Output_Path": "CoderEval4Java_heuristic.json",
    "jsonl": False,
    }
...
RESULT_FOLDER = "../../Automated_Analysis_Results/"
...
def apply_rules(current_dataset: dict, data: object) -> None:
    ...
    if "CONCODE" in current_dataset["Source_Path"]:
        ...
        and "mbpp" in current_dataset["Source_Path"]
    ):
        nl_docs = process_mbxp_python_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "mbxp" in current_dataset["Source_Path"]
        and "mbjp" in current_dataset["Source_Path"]
    ):
        nl_docs = process_mbxp_java_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "mbxp_humaneval" in current_dataset["Source_Path"]
        and not "java" in current_dataset["Source_Path"]
    ):
        nl_docs = process_mbxp_humaneval_python_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "mbxp_humaneval" in current_dataset["Source_Path"]
        and "java" in current_dataset["Source_Path"]
    ):
        nl_docs = process_mbxp_humaneval_java_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "mbxp_mathqa" in current_dataset["Source_Path"]
        and "python" in current_dataset["Source_Path"]
    ):
        ...
        "ODEX" in current_dataset["Source_Path"]
        and "en" in current_dataset["Source_Path"]
    ):
        nl_docs = process_odex_en_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "pandasNumpyEval" in current_dataset["Source_Path"]
        and "numpy" in current_dataset["Source_Path"]
    ):
        nl_docs = process_pandasNumpyEval_numpy_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "pandasNumpyEval" in current_dataset["Source_Path"]
        and "pandas" in current_dataset["Source_Path"]
    ):
        nl_docs = process_pandasNumpyEval_pandas_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "CoderEval" in current_dataset["Source_Path"]
        and "Python" in current_dataset["Source_Path"]
    ):
        ...
        nl_docs = process_CoderEval_java_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "MCoNaLa" in current_dataset["Source_Path"]
        and "es_test_to_en" in current_dataset["Source_Path"]
    ):
        nl_docs = process_MCoNaLa_es_test_to_en_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "MCoNaLa" in current_dataset["Source_Path"]
        and "ja_test_to_en" in current_dataset["Source_Path"]
    ):
        nl_docs = process_MCoNaLa_ja_test_to_en_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "MCoNaLa" in current_dataset["Source_Path"]
        and "ru_test_to_en" in current_dataset["Source_Path"]
    ):
        ...
        "TorchDataEval" in current_dataset["Source_Path"]
        and "monkey" in current_dataset["Source_Path"]
    ):
        ...
        "TorchDataEval" in current_dataset["Source_Path"]
        and "make_sense" in current_dataset["Source_Path"]
    ):
        nl_docs = process_torch_data_makesense_eval_v3_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "CodeComplex" in current_dataset["Source_Path"]
        and "extend_data" in current_dataset["Source_Path"]
    ):
        nl_docs = process_CodeComplex_extend_data_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "CodeComplex" in current_dataset["Source_Path"]
        and "new_data" in current_dataset["Source_Path"]
    ):
        nl_docs = process_CodeComplex_new_data_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "JigsawDataset" in current_dataset["Source_Path"]
        and "PandasEval1" in current_dataset["Source_Path"]
    ):
        nl_docs = process_Jigsaw_PandasEval1_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "JigsawDataset" in current_dataset["Source_Path"]
        and "PandasEval2" in current_dataset["Source_Path"]
    ):
        nl_docs = process_Jigsaw_PandasEval2_dataset(data)
        write_path += current_dataset["Output_Path"]
    elif (
        "MBPP" in current_dataset["Source_Path"]
